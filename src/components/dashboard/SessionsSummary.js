...
const SessionsSummary = ({
  ...
  return (
    <div
      ...
      } rounded-2xl p-5 relative overflow-hidden transition-all duration-500 transform ${scaleInClass} ${fadeInClass} delay-500 
    ...
    >
      ...
      <h2 className="text-xl font-bold mb-4 relative z-20">Sessions:</h2>
      ...
      <div className="flex mt-4 justify-center relative z-20">
